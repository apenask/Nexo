      ...
      <div className="w-full max-w-xl rounded-3xl border border-zinc-800 bg-zinc-950 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 px-6 py-6">
          <div className="space-y-2">
            <label className="text-sm font-medium text-zinc-300">Nome da categoria</label>
            <input
              value={name}
          ...
          <div className="space-y-3">
            <label className="text-sm font-medium text-zinc-300">Cor da categoria</label>
          ...
          <div className="space-y-4 rounded-3xl border border-zinc-800 bg-zinc-900/40 p-5">
            <div className="flex items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-3xl font-bold text-zinc-50">{budgetPercentage}%</p>
              </div>
            ...
            <div className="rounded-2xl border border-zinc-800 bg-black/20 p-4">
              ...
              <div className="mt-3 h-2 rounded-full bg-white/10 overflow-hidden">
                <div
                  className={`h-full rounded-full ${exceedsLimit ? "bg-rose-400" : "bg-zinc-100"}`}
